<?php
/**
 * صفحة خدمات هندسة الاتصالات وتقنية المعلومات
 */
...
$fieldInfo = [
    ...
    'description' => 'دورات وخدمات تقنية متخصصة في البرمجة، الشبكات، وأمن المعلومات',
    'color' => '#0077b6'
];
...
$services = [
    [
        'id' => 1,
        'name' => 'دورة برمجة المواقع الكاملة',
        'icon' => 'fa-code',
        'description' => 'تعلم تطوير المواقع من الصفر: HTML, CSS, JavaScript, PHP, MySQL',
        'price' => '150',
        'duration' => '40 ساعة'
    ],
    [
        ...
        'icon' => 'fa-mobile-alt',
        'description' => 'بناء تطبيقات احترافية باستخدام Flutter أو React Native',
        'price' => '200',
        'duration' => '50 ساعة'
    ],
    [
        'id' => 3,
        'name' => 'أمن المعلومات والحماية',
        'icon' => 'fa-shield-alt',
        'description' => 'تعلم أساسيات أمن المعلومات وحماية الأنظمة من الاختراقات',
        'price' => '180',
        'duration' => '35 ساعة'
    ],
    [
        'id' => 4,
        'name' => 'إدارة وتصميم الشبكات',
        'icon' => 'fa-network-wired',
        'description' => 'تصميم وإدارة الشبكات المحلية والواسعة وحل مشاكلها',
        'price' => '160',
        'duration' => '30 ساعة'
    ],
    [
        ...
        'icon' => 'fa-database',
        'description' => 'تصميم وإدارة قواعد البيانات: MySQL, PostgreSQL, MongoDB',
        'price' => '140',
        'duration' => '25 ساعة'
    ],
    [
        ...
        'name' => 'استشارة تقنية',
        'icon' => 'fa-lightbulb',
        'description' => 'جلسة استشارية مع خبير تقني لحل مشاكلك أو تطوير مشروعك',
        'price' => '50',
        'duration' => 'ساعة واحدة'
    ]
];
...
<head>
    ...
    <meta name="keywords" content="برمجة, تطوير مواقع, تطبيقات, أمن معلومات, شبكات, قواعد بيانات, عمان">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-card">
                    ...
                    <button class="btn btn-request" onclick="alert('سيتم تفعيل نظام الطلبات قريباً. تواصل معنا مباشرة!')">
    ...
    <section class="container mb-5">
        <div class="text-center p-5 rounded-4" style="background: linear-gradient(135deg, rgba(6, 103, 85, 0.1), rgba(0, 212, 255, 0.1)); border: 3px solid #066755;">
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                ...
                <a href="../join.php" class="btn btn-outline-secondary btn-lg" style="padding: 15px 40px; border-radius: 15px; font-weight: 700;">
